# -*- coding: utf-8 -*-
"""Copy of DataHacker.rs YoloV3 in TF 2.0.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1iUlSS5fH5rYmrQdm8Xo0IyZNrsyt7Dh5
...
Where N is the number of labels in batch, and 6 represents \begin{equation}[x,y,w,h,obj,class]\end{equation} of the bounding boxes.
"""
...
name = '/content/test.jpg'     # path to test image
...
*   [YOLOv3 – Joseph Redmon](https://pjreddie.com/media/files/papers/YOLOv3.pdf)
